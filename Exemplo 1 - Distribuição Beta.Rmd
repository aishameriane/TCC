---
title: "Figuras cap 1 - Distribuição Beta"
...
Essa versão não foi utilizada no texto final.
...
Salva a figura em PDF (para ativar o chunk, apague o `eval = FALSE`). Lembre-se de editar os três pontos para editar o diretório para salvar a imagem no seu computador.
...
Este código gera as figuras que foram utilizadas no texto final.

O primeiro chunk gera 4 distribuições betas com parâmetros diferentes.
